...
//==================================================
//修改历史：
//1、2013-11-13 将dtree修改成可以单选的树，
//   将name转变成<input type='radio'>
//
//==================================================
// Node object
...
function dTree(objName,path) {
	...
	this.icon = {
		root				: path+'/js/dtree/images/base.gif',
		folder			: path+'/js/dtree/images/folder.gif',
		folderOpen	: path+'/js/dtree/images/folderopen.gif',
		node				: path+'/js/dtree/images/page.gif',
		empty				: path+'/js/dtree/images/empty.gif',
		line				: path+'/js/dtree/images/line.gif',
		join				: path+'/js/dtree/images/join.gif',
		joinBottom	: path+'/js/dtree/images/joinbottom.gif',
		plus				: path+'/js/dtree/images/plus.gif',
		plusBottom	: path+'/js/dtree/images/plusbottom.gif',
		minus				: path+'/js/dtree/images/minus.gif',
		minusBottom	: path+'/js/dtree/images/minusbottom.gif',
		nlPlus			: path+'/js/dtree/images/nolines_plus.gif',
		nlMinus			: path+'/js/dtree/images/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if(node.pid == this.root.id){
		...
		/**组装checkbox开始*/
		checkboxSyntax = "<input type='radio' desc='" + node.cshow + "' name='" + node.cname + "' id='" + node.cname +  "' value='" + node.cvalue + "'  ";
		//是否被选中
		if(node.cchecked)
